...
from .private_agent_managers import create_agent, create_agent_executor
from .private_tools import create_tools
import os
...
class PrivateAgent:
    def __init__(self,messages, agent_name, faiss_path):
    ...
    def run_conversation(self, user_input):
        ...
        agent = create_agent(self.client, tools=tools, agent_name = self.agent_name)
